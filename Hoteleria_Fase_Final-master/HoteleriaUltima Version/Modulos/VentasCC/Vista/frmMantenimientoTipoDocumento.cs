...
{
    public partial class frmMantenimientoTipoDocumento : Form
    {
        public frmMantenimientoTipoDocumento()
        {
            InitializeComponent();
            //TextBox[] alias = { txtID, txtCodigoMarca, txtNombre, txtFecha, txtDescripcion, txtStock, txtPrecio, txtEstatus};
            TextBox[] alias = navegador1.funAsignandoTexts(this);
            navegador1.funAsignarAliasVista(alias, "TipoDocumento", "hotelSanCarlos");
            ...
            navegador1.pideGrid(this.dtgTipoDocumento);
        ...
        {
            navegador1.funSeleccionarDTVista(dtgTipoDocumento);
        }
    }
}

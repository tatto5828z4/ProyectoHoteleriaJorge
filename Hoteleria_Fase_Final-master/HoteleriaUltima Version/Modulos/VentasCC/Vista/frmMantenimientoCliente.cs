    ...
    public partial class frmMantenimientoCliente : Form
    {
        public frmMantenimientoCliente()
        {
           ...
           // navegador1.funLlenarComboControl(cbxCodMarca, "marcaP", "idMarca", "nombre", "estatus");
            ...
            navegador1.pideGrid(this.dtgClientes);
        ...
        {
            navegador1.funCambioEstatusRBVista(txtEstatus, rbnActivo, "1");
        }

        private void rbnInactivo_CheckedChanged(object sender, EventArgs e)
        {
            navegador1.funCambioEstatusRBVista(txtEstatus, rbnInactivo, "0");
        }
        private void txtEstatus_TextChanged(object sender, EventArgs e)
        {
            navegador1.funSetearRBVista(rbnActivo, rbnInactivo, txtEstatus);
        }
        private void dvgConsulta_SelectionChanged(object sender, EventArgs e)
        {
            navegador1.funSeleccionarDTVista(dtgClientes);
        }

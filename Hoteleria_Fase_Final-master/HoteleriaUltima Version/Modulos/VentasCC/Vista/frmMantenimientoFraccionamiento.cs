...
{
    public partial class frmMantenimientoFraccionamiento : Form
    {
        public frmMantenimientoFraccionamiento()
        {
            InitializeComponent();
            //TextBox[] alias = { txtID, txtCodigoMarca, txtNombre, txtFecha, txtDescripcion, txtStock, txtPrecio, txtEstatus};
            TextBox[] alias = navegador1.funAsignandoTexts(this);
            navegador1.funAsignarAliasVista(alias, "Fraccionamiento", "hotelSanCarlos");
            ...
            navegador1.pideGrid(this.dtgFraccionamiento);
        ...
        {
            navegador1.funSeleccionarDTVista(dtgFraccionamiento);
        }
    }
}

...
{
    public partial class frmMantenimientoMora : Form
    {
        public frmMantenimientoMora()
        {
            InitializeComponent();
            //TextBox[] alias = { txtID, txtCodigoMarca, txtNombre, txtFecha, txtDescripcion, txtStock, txtPrecio, txtEstatus};
            TextBox[] alias = navegador1.funAsignandoTexts(this);
            navegador1.funAsignarAliasVista(alias, "Mora", "hotelSanCarlos");
            ...
            navegador1.pideGrid(this.dtgMoras);
        ...
        {
            navegador1.funSeleccionarDTVista(dtgMoras);
        }

...
namespace CapaVistaHoteleria
{
    public partial class frmTipoHabitacion : Form
    {
        public frmTipoHabitacion()
        {
            ...
            navegador1.funAsignarAliasVista(alias, "tipoHabitacion", "hotelSanCarlos");
            ...
            navegador1.pideGrid(dgvTipoHabitacion);
            ...
            navegador1.aplicacion = "Mantenimiento Tipo Habitación";
        ...
        {
            navegador1.funSeleccionarDTVista(dgvTipoHabitacion);
        }
